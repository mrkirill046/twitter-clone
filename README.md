...
# Create database
## Create database in https://supabase.com
```postgres-psql
...
# Installation
1. Clone the repository: `git clone https://github.com/mrkirill046/twitter-clone.git`
...
```
## Update colum username from profiles in supabse
```
Allow Nullable -> OFF
```
